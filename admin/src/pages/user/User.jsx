                ...
                <div className="userShow">
                    <div className="userShowTop">
                        ...
                        <div className="userShowTopTitle">
                            <span className="userShowUsername">Anna Karen</span>
                    ...
                    <div className="userShowBottom">
                        ...
                        <div className="userShowInfo">
                            ...
                            <span className="userShowInfoTitle">AnnKarr99</span>
                        </div>
                        <div className="userShowInfo">
                        ...
                        <div className="userShowInfo">
                            ...
                            <span className="userShowInfoTitle">AnnKarr99@mail.com</span>
                        </div>
                        <div className="userShowInfo">
                    ...
                    <form action="" className="userUpdateForm">
                        <div className="userUpdateLeft">
                            <div className="userUpdateItem">
                                ...
                                <input type="text" placeholder="AnnKarr99" className="userUpdateInput" />
                            </div>
                            <div className="userUpdateItem">
                                <label>Full Name</label>
                                <input type="text" placeholder="Anna Karen" className="userUpdateInput" />
                            </div>
                            <div className="userUpdateItem">
                                <label>Email</label>
                                <input type="text" placeholder="AnnKarr99@mail.com" className="userUpdateInput" />
                            </div>
                            <div className="userUpdateItem">
                                <label>Phone</label>
